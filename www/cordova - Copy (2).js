...
; (function () {
    ...
    define("cordova", function (require, exports, module) {
        ...
        var cordova = {
            ...
            //exec: function () {
            //    console.log('I am Cordova.Exec');
            //},


            exec: function (service, action, callbackId, argsJson, a) {
...
//module.exports = AppTracker;
    ...
    define("cordova/plugin/android/promptbasednativeapi", function (require, exports, module) {
        ...
        module.exports = {
            exec: function (service, action, callbackId, argsJson) {
              //  alert('efine("cordova/plugin/android/promptba');
                return prompt(argsJson, 'gap:' + JSON.stringify([service, action, callbackId]));
            },
    ...
    //=====Raz----------AddTracker=======
    define('cordova/plugin/AddTracker', function (require, exports, module) {
        //var app = {
